...
export const FILMS: Film[] = [
  {
      ...
      description: "Steve Rogers becomes Captain America, battling the Red Skulland Hydra in World War II, while struggling to adapt to a changed world after being frozen for decades.",
      image: "captain_america.jfif",
      rating: 8.5,
      year: 2008,
      genre: "Comedy",
      isNew: true,
      trailerUrl : "https://www.youtube.com/watch?v=MV2nYw6gL_w"
    },
    {
      id: 2,
      title: "Back Action",
    ...
    },
    {
      ...
      description: "Stuck on a deserted island, a family battles the elements and an uncertain future, finding resilience in the harsh realities of survival.",
